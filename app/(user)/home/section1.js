        ...
        <div className="relative">
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-start sm:items-center gap-8">
            <button
              ...
              className="bg-[#b89047] text-white pl-6 pr-2 py-2 rounded-full flex items-center gap-4 hover:bg-[#dc9e2d] transition-all shadow-lg shadow-[#b89047]/30 cursor-pointer"
            >
              <span className="font-semibold text-sm">Appointment</span>
              <span className="bg-white text-[#b89047] w-10 h-10 rounded-full flex items-center justify-center shadow-sm">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 24 24"
